...
export const VerifiedUser = () => {
    return (
        <>
            <div className='mt-2 w-41.5 h-5 md:text-[50] border-dotted border-2 border-spacing-28 border-[#818181] md:w-50 md:h-6.5 lg:w-58 lg:py-4 rounded-[42px] gap-1.5 flex items-center justify-center'>
