    ...
    return (
        <Dialog>
            <div className='flex items-center justify-center'>  
                <Item className='lg:h-29 w-79 h-30 md:h-35 md:w-113 lg:w-[55vw] bg-linear-to-r from-chart-1 to-chart-2 rounded-[14px] lg:py-3 lg:px-8 lg:items-center lg:justify-between'>
