    ...
    return (
        <div className="flex flex-col gap-9 min-h-screen items-center justify-center bg-gray-200 py-14">
            ...
            <div className="bg-white w-77.5 h-154.25 rounded-[9px] lg:w-228 lg:h-234.5 lg:rounded-[14px]">
                <div className="relative flex items-center justify-center bg-popover w-77.5 h-49 rounded-t-[9px] p-24 lg:justify-start lg:w-228 lg:h-62.25 lg:rounded-t-[14px] ">
                    ...
                    <div className="flex flex-col items-center lg:flex-row lg:items-start lg:gap-14">
                        ...
                        <div className="flex flex-col items-center lg:items-start">
                            <h3 className="text-primary font-bold text-[17px] lg:text-[36px]">Nombre de ejemplo</h3>
                            <div className="flex items-center flex-col-reverse gap-2 lg:gap-4 lg:flex-col lg:items-start">
                                <Star className="fill-chart-5 text-chart-5 h-3 w-3 lg:w-5.75 lg:h-5.75" />
                                
                                <div className="flex flex-col items-center lg:flex-row lg:gap-8">
                                    <div className="flex gap-2 items-center">
                                        <Phone className="text-primary h-3 w-3 lg:w-5 lg:h-5" />
                                        <p className="text-chart-4 text-[12px] lg:text-[16px]">315-887-9086</p>
                                    </div>
                                    <div className="flex gap-2 items-center">
                                        <AtSign className="text-primary h-3 w-3 lg:w-5 lg:h-5" />
                                        <p className="text-chart-4 text-[12px] lg:text-[16px]">ejemplo@.edu.co</p>
                                    </div>
                                </div>
                            </div>
                            <VerifiedUser />
                ...
                {/* Contenido | cuadro II */}
                <div className='px-8 py-5 flex flex-col gap-7 lg:px-20 lg:py-10 lg:gap-11'>
