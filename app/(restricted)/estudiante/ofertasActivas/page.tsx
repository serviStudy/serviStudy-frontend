        ...
        return (
            <div className="flex h-[70vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-gray-500 font-medium animate-pulse">Cargando las mejores ofertas...</p>
                </div>
            </div>
        )
    }
        ...
        <div className="flex flex-col min-h-screen pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_450px] xl:grid-cols-[1fr_500px] gap-8 items-start">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex items-center justify-between px-2">
                        <h3 className="text-xl font-bold text-blue-900">
                            Resultados <span className="text-blue-500 ml-1">({filteredOffers.length})</span>
                        </h3>
                    </div>
                    ...
                    {filteredOffers.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-[32px] border border-dashed border-gray-200">
                            ...
                            <p className="text-gray-500 max-w-[250px] text-center mt-2">
                ...
                <div className="hidden lg:block sticky top-8">
                    {selectedOffer ? (
                        <div className="h-[calc(100vh-100px)] overflow-y-auto no-scrollbar rounded-[32px] shadow-sm border border-gray-100">
                ...
                <div className="lg:hidden mt-8">
                    {selectedOffer && (
                        <div className="flex flex-col gap-4">
                            <h3 className="text-xl font-bold text-blue-900 px-2">Detalles de la oferta</h3>
