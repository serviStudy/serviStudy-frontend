    ...
    return (
        <div className="flex min-h-screen items-center justify-center">
            <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
                ...
                <div className="absolute w-150 h-150 bg-green-400/30 rounded-full blur-[140px] -top-37.5 -left-37.5" />
                <div className="absolute w-125 h-125 bg-emerald-300/30 rounded-full blur-[140px] top-[20%] -right-25" />
                <div className="absolute w-150 h-150 bg-lime-000/30 rounded-full blur-[140px] -bottom-50 left-[20%]" />
                <div className="absolute w-100 h-100 bg-green-300/40 rounded-full blur-[120px] top-[40%] left-[10%]" />
                <div className="absolute w-87.5 h-87.5 bg-emerald-400/40 rounded-full blur-[120px] bottom-[10%] right-[20%]" />
                <div className="absolute w-62.5 h-62.5 bg-lime-400/50 rounded-full blur-[100px] top-[60%] left-[40%]" />
                <div className="absolute w-50 h-50 bg-green-200/60 rounded-full blur-[90px] top-[10%] left-[50%]" />
            </div>
