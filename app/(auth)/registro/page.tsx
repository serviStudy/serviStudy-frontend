...
const Page = () => {
    ...
    return (
        <div className="relative flex flex-col min-h-screen items-center 8 px-4 md:pt-32 md:justify-center transition-all duration-1000 ease-in-out overflow-hidden">
