                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="shrink-0 flex items-center justify-center">
                            {data.jobOffer.imageUrl ? (
                                ...
                                <div className="w-14 h-14 bg-emerald-50 rounded-xl flex items-center justify-center font-bold text-emerald-600 text-2xl uppercase">
            ...
            <div className="hidden md:block">
                <div className="group bg-white rounded-xl border border-gray-200 p-6 flex flex-col md:flex-row gap-6 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden w-full">
                    ...
                    <div className="shrink-0 flex items-center justify-center md:items-start">
                        {data.jobOffer.imageUrl ? (
                            <div className="w-16 h-16 md:w-28 md:h-28 bg-gray-50 rounded-xl overflow-hidden border-2 border-gray-100 shadow-sm transition-transform group-hover:scale-105 flex items-center justify-center">
                                <Image
                                    width={80}
                                    height={80}
                                    src={data.jobOffer.imageUrl || "/placeholder-job.png"}
