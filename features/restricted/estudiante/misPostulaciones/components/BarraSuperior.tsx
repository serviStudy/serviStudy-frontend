...
export const BarraSuperior = () => {
    return (
        <div className='flex md:flex-row  gap-4 flex-col items-center justify-between w-full bg-white rounded-3xl p-6 shadow-sm border border-gray-100'>
            <div className='flex flex-col md:gap-1'>
                <div className='flex items-center gap-3'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-900 leading-none'>Mis Postulaciones</h2>
                </div>
