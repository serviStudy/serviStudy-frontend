...
export const OfferDetailPostulationHeader = ({ offer }: Props) => {
  ...
  return (
    <>
      <div className="bg-linear-to-br from-[#1a3683] via-[#2552d0] to-[#3a6bf0] rounded-t-3xl p-7 md:p-9 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden">
        {/* Decoración de fondo */}
        ...
        <div className="flex items-center gap-6 z-10 w-full md:w-auto">
          ...
          <div className="flex flex-col gap-1 min-w-0">
            ...
            <p className="text-blue-200 font-semibold text-lg md:text-xl capitalize">{offer.businessName}</p>
            <div className="flex items-center gap-1.5 text-blue-100 mt-1">
              <MapPin size={16} className="shrink-0" />
              <span className="text-sm font-medium leading-tight capitalize">{offer.establishmentAddress}</span>
            </div>
          </div>
        </div>
