...
import { CheckCircle2, Mail, Phone, Pencil } from 'lucide-react'
...
export const AvatarCard = ({ variants, profile, email, inicial, isPremium }: AvatarCardProps) => {
    return (
        <motion.div variants={variants} className={`relative w-full rounded-xl overflow-hidden shadow-sm ${
            isPremium 
            ...
            <div className="h-48 lg:h-56 w-full relative overflow-hidden bg-linear-to-r from-blue-800 via-indigo-500 to-blue-600">
                ...
                <div className="absolute top-5 right-5 sm:top-8 sm:right-10 flex gap-4">
                    <Link
                        ...
                        className={`px-3 py-2 sm:px-6 sm:py-3 rounded-lg font-bold text-[10px] sm:text-xs flex items-center gap-2 shadow-sm transition-all active:scale-95 ${
                            isPremium
            ...
            <div className="px-5 sm:px-10 lg:px-16 pb-10">
                <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 items-center lg:items-end -mt-16 lg:-mt-20">
                    ...
                    <div className="relative shrink-0">
                        <div className={`h-32 w-32 sm:h-36 sm:w-36 lg:h-40 lg:w-40 rounded-xl overflow-hidden flex items-center justify-center ${
                            isPremium
                            ...
                            {profile.imgUrl ? (
                                ...
                                <span className={`text-[48px] sm:text-[60px] lg:text-[72px] font-black ${
                                    isPremium ? 'text-blue-600/20' : 'text-green-700/20'
                                }`}>
                                    {inicial}
                                </span>
                            )}
