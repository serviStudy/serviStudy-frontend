...
export const ProfileHeader = ({ variants }: ProfileHeaderProps) => {
    return (
        <motion.div 
            variants={variants}
            className="w-full max-w-6xl mx-auto h-48 md:h-56 rounded-xl bg-gradient-to-br from-blue-900 via-blue-700 to-blue-600 relative overflow-hidden shadow-sm"
        >
            ...
            <Link
                ...
                className="absolute top-6 right-6 bg-white/20 backdrop-blur-md p-3 rounded-lg hover:bg-white/30 transition-all shadow-md border border-white/20 z-10"
            >
