        ...
        <motion.div variants={variants} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex items-center justify-between gap-3 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-blue-900">Mis Postulaciones</h3>
                </div>
                    ...
                    {applications.map((app) => (
                        <div key={app.jobOffer.jobOfferId} className="group relative bg-white border border-gray-100 rounded-xl p-5 hover:border-blue-200 hover:shadow-md transition-all">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-5">
                                ...
                                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-gray-50 flex items-center justify-center overflow-hidden shrink-0">
                                    <Image
                                        width={80}
                                        height={80}
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-2">
                                        <div>
                                            <h4 className="text-lg font-bold text-blue-900 leading-tight mb-1 group-hover:text-blue-600 transition-colors">
                                                {app.jobOffer.title}
                                            </h4>
                                            <div className="flex items-center gap-2 text-blue-600">
                                                <Briefcase className="h-3.5 w-3.5" />
                                                <span className="text-sm font-semibold">{app.jobOffer.businessName}</span>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2 bg-blue-50/50 px-2.5 py-1 rounded-lg border border-blue-100">
                                            <Calendar className="h-3 w-3 text-blue-500" />
                                            <span className="text-[10px] font-bold text-blue-600 uppercase tracking-wider">{app.applicationDate}</span>
                                        </div>
                                    </div>
