  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 mt-6">
      ...
      <motion.button
        ...
        onClick={() => router.back()}
        className="group mb-4 flex items-center gap-2 text-gray-500 hover:text-green-600 font-bold px-4 py-2.5 rounded-xl bg-white hover:bg-green-50/50 border border-gray-100 shadow-xs hover:shadow-sm active:scale-95 transition-all duration-300 cursor-pointer"
      >
      ...
      <motion.div
        ...
        className="w-full h-44 md:h-56 rounded-3xl bg-linear-to-br from-green-500 via-emerald-600 to-blue-900 relative overflow-hidden shadow-md border border-white/10"
      >
