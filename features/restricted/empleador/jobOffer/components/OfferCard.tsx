  ...
  return (
    <div className="w-full">
      ...
      <motion.div 
        ...
        className="lg:hidden group bg-white rounded-2xl border border-gray-100 border-l-4 border-l-green-500 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden mb-4"
      >
        
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="w-20 h-20 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center shadow-inner shrink-0 overflow-hidden">
              {imageUrl ? (
            ...
            <div className="min-w-0 flex flex-col gap-4">
              <h3 className="text-[17px] font-bold text-green-900  truncate capitalize leading-tight mb-0.5">{offer.title}</h3>
        ...
        {showActions && (
          <div className="items-center gap-2 pt-2 border-t border-gray-50 mt-2">
            <Link 
              href={`/empleador/ofertas/${offerId}`} 
            >
              <Button className="flex-1 bg-green-600 text-white h-10 rounded-xl w-full text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-1 shadow-lg shadow-green-600/20 active:scale-95">
            ...
            {showActions && (
              <div className="flex items-end gap-4 shrink-0">
                ...
                >
                  ...
                  />
                  <span className={`absolute w-full text-center text-sm font-semibold tracking-widest transition-all duration-500 ${isActive ? "text-green-600 -left-3" : "text-orange-600 left-3"}`}>
