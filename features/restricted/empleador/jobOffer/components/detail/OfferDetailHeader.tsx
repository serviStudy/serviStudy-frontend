...
export const OfferDetailHeader = ({ offer }: Props) => {
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-green-900 via-green-700 to-green-600 rounded-t-3xl p-7 md:p-9 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 z-10 w-full md:w-auto">
          {/* Logo */}
          <div className="shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden bg-white shadow-lg border-2 border-white/40">
            {imageUrl ? (
          ...
          <div className="flex flex-col gap-1 min-w-0">
            <h1 className="text-2xl md:text-3xl font-bold text-white leading-tight tracking-tight capitalize">
              {offer.title}
            </h1>
            <p className="text-green-200 font-semibold text-lg md:text-xl capitalize">
              {profile?.businessName || (profile as any)?.business_name || "Tu Empresa"}
            </p>
            <div className="flex items-center gap-1.5 text-green-100 mt-1">
        ...
        <div className="z-10 mt-4 md:mt-0 w-full md:w-auto flex justify-end">
          <Link
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl border border-white/20 backdrop-blur-sm transition-all shadow-sm w-full md:w-auto group"
          >
