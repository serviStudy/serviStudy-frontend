        ...
        <div className="px-5 sm:px-10 lg:px-16 pb-12">
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 items-center lg:items-end -mt-16 lg:-mt-20">
            ...
            <div className="relative shrink-0">
              <div className={`h-32 w-32 sm:h-40 sm:w-40 lg:h-48 lg:w-48 rounded-lg p-5 sm:p-6 flex items-center justify-center ${isPremium
                ...
                {(profile.imageUrl || profile.image_url) ? (
                  ...
                  <span className={`text-[60px] sm:text-[80px] lg:text-[100px] font-black ${isPremium ? 'text-blue-600/10' : 'text-green-700/10'
                    }`}>
                    {inicial}
                  </span>
                )}
            ...
            <div className="flex-1 text-center lg:text-left lg:pb-6 min-w-0">
              <div className="flex flex-col lg:flex-row lg:items-center gap-3 sm:gap-4 mb-2 flex-wrap justify-center lg:justify-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={item.label} className={`group relative p-5 sm:p-6 rounded-2xl overflow-hidden transition-all duration-300 ${isPremium
                ...
                <div className={`relative z-10 w-11 h-11 rounded-[13px] flex items-center justify-center mb-5 transition-transform duration-300 group-hover:scale-110 ${isPremium
                  ? `bg-gradient-to-br ${item.gradient} text-white shadow-lg shadow-blue-500/10`
                  : 'text-green-600 bg-green-50'
                  }`}>
                  <item.icon size={20} />
                </div>
                <p className={`text-[10px] sm:text-xs font-semibold uppercase tracking-widest mb-1.5 ${isPremium ? 'text-gray-400' : 'text-gray-400'
                  }`}>{item.label}</p>
