      ...
      <div className="w-full rounded-xl bg-white shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="px-6 lg:px-12 -mt-20 relative pb-10">
          <div className="flex flex-col lg:flex-row gap-8 lg:items-end">
            {/* Avatar Skeleton */}
            <div className="h-32 w-32 rounded-xl bg-gray-200 border-[8px] border-white lg:h-44 lg:w-44 shadow-lg shrink-0"></div>
            
            <div className="flex flex-col flex-1 pb-6">
               <div className="h-10 w-2/3 bg-gray-200 rounded-lg mb-4"></div>
               <div className="h-6 w-1/3 bg-gray-100 rounded-lg mb-6"></div>
