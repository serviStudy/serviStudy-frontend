    ...
    return (
        ...
        >
            ...
            <button onClick={handleToggleStatus} disabled={isChanging} className={`flex relative items-center h-8 w-24 rounded-full border transition-all px-1 ${isActive ? "bg-green-50 border-green-200" : "bg-orange-50 border-orange-200"}`}>
                <div className={`w-6 h-6 rounded-full shadow-md transition-all transform flex items-center justify-center ${isActive ? "bg-green-600 translate-x-16" : "bg-orange-500 translate-x-0"}`}>
                <div className="w-1 h-1 rounded-full bg-white animate-pulse" />
                </div>
                <span className={`absolute w-full text-center text-[8px] font-black uppercase tracking-wider z-10 ${isActive ? "text-green-700 -left-2" : "text-orange-900 left-2"}`}>
        ...
        >
            ...
            <div className="flex-1 flex flex-col min-w-0">
                <div className="flex justify-between items-start gap-6">
                    ...
                    <div className="flex items-center gap-4 shrink-0">
                        <button onClick={handleToggleStatus} disabled={isChanging} className={`flex relative items-center h-12 w-36 rounded-full border-2 transition-all duration-700 shadow-sm active:scale-95 px-2 ${isActive ? "border-green-100 bg-green-50/50" : "border-orange-100 bg-orange-50/50"}`}>
                            <div className={`w-8 h-8 rounded-full transition-all duration-700 shadow-lg transform flex items-center justify-center ${isActive ? "bg-green-600 translate-x-23" : "bg-orange-500 translate-x-0"}`}>
                            <div className="w-2 h-2 rounded-full bg-white animate-pulse" />
                            </div>
                            <span className={`absolute w-full text-center text-[11px] font-black uppercase tracking-[0.15em] z-10 transition-all duration-700 ${isActive ? "text-green-700 -left-3.75" : "text-orange-900 left-3.75"}`}>
                ...
                <div className="pt-1 pb-4.5">
                    <p className="text-sm text-gray-400 capitalize">{offer.description}</p>
                </div>
                ...
                <div className="flex justify-between items-center border-t pt-2 border-gray-100">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <div className="text-green-600 flex items-center gap-2 bg-green-50 px-4 py-1.5 rounded-lg border border-green-100 shadow-sm">
                            <span className="text-[12px] font-bold uppercase tracking-wider opacity-70">Sueldo</span>
