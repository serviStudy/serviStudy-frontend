          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-1 text-sm font-semibold">
              <span className="text-green-600 flex items-center gap-1">
                ...
                <span className="truncate max-w-37.5 inline-block">{offer.establishment_address || offer.establishmentAddress}</span>
              </span>
            ...
            >
              <div
                className={`absolute w-6 h-6 rounded-full transition-all duration-300 shadow-sm ${
                  isActive ? "bg-[#34c759] left-1" : "bg-orange-500 left-20.5"
                }`}
              ></div>
              <span 
