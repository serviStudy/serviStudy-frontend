...
import { OfferDetailHeader } from "@/features/restricted/employer/jobOffer/components/detail/OfferDetailHeader";
...
export const OfferDetailPostulation = ({ id }: Props) => {
    ...
    if (error || !offer) {
        ...
        <div className="flex flex-col items-center justify-center h-[80vh]">
            <p className="text-gray-500">{error || "No se encontró la oferta"}</p>
            <LoadingScreen />
        </div>
        );
    }
