...
export const HeaderInfoCard = ({ offer }: HeaderInfoProps) => {
    ...
    return (
        <div className="relative rounded-t-2xl h-24 md:h-26 bg-[#E2FFE1] w-full flex flex-col lg:flex-row gap-6! md:gap-10! lg:gap-8 lg:items-end px-8">
            {/* foto de la oferta */}
            ...
            <div className="pt-10 px-4 flex flex-col pl-22 md:pl-24 leading-none space-y-0 lg:pb-2">
                ...
                <p className="text-lg mb-0 leading-none font-medium text-[#1a4b9e] lg:text-[15px]">{offer.establishmentAddress}</p>
            </div>
        </div>
    )
}
