...
const SearchCard = ({ inputValue, onInputChange, onSearch }: Props) => {
    return (
        <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex gap-4'>
                        <div className="relative w-full max-w-md">
                            <input 
                                ...
                                className='lg:w-64 md:w-90 w-72 h-7 md:h-8 flex justify-center text-gray-400 lg:h-9 pr-12 pl-4 border rounded-full'
            ...
            <Button className='flex gap-2 w-50 items-center rounded-2xl lg:hidden'>
                <BriefcaseBusiness/>
